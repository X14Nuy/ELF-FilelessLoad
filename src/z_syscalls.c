...
// my add
DEF_SYSCALL3(int, socket, int, domain, int, type, int, protocol)
DEF_SYSCALL3(int, bind, int, sockfd, const struct sockaddr *, addr, socklen_t, addrlen)
// DEF_SYSCALL3(int, accept, int, sockfd, struct sockaddr *, addr, int *, addrlen)
DEF_SYSCALL2(int, listen, int, sockfd, int, backlog)
